...
export default function HomeDashboard() {
  const { agents, knowledgeBases, sessions, createNewSession, setCurrentView, setCurrentSessionId } = useStore();
      ...
      <div className="mb-10 bg-gradient-to-r from-blue-600 to-indigo-700 rounded-2xl p-6 text-white shadow-lg relative overflow-hidden group">
        ...
        <div className="relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {/* Step 1 */}
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/10 hover:bg-white/20 transition cursor-pointer" onClick={() => setCurrentView('knowledge')}>
            ...
            {/* Step 2 */}
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/10 hover:bg-white/20 transition cursor-pointer" onClick={() => setCurrentView('agent')}>
              <div className="flex items-center justify-between mb-2">
            ...
            {/* Step 3 */}
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/10 hover:bg-white/20 transition cursor-pointer" onClick={createNewSession}>
              <div className="flex items-center justify-between mb-2">
          ...
          {sessions.length === 0 ? (
            ...
            <div className="divide-y divide-gray-100">
              {sessions.slice(0, 5).map(session => (
                <div 
                  key={session.id} 
                  onClick={() => { setCurrentSessionId(session.id); setCurrentView('chat'); }}
